  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-card border-primary/20">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-primary font-arabic">{capabilities.title}</h2>
      ...
      <Card className="shadow-card">
        <CardHeader>
          <CardTitle className="font-arabic text-primary">قائمة الطلاب</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {students.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground font-arabic">لا يوجد طلاب متاحين</p>
              </div>
            ) : (
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Dialog 
                            open={isAddingLog && selectedStudent?.id === student.id} 
                            onOpenChange={(open) => {
                              setIsAddingLog(open);
                              if (open) {
                              ...
                              <div className="space-y-4">
                                {capabilities.canGradeMem && (
                                  <>
                                    ...
                                    <div className="space-y-2">
                                      <Label htmlFor="memGrade">درجة الحفظ</Label>
                                      <Input
                                        id="memGrade"
                                        value={newLog.memGrade}
                                        onChange={(e) => setNewLog({ ...newLog, memGrade: e.target.value })}
                                  ...
                                  <>
                                    <div className="space-y-2">
                                      ...
                                      <Select
                                        ...
                                        onValueChange={(value) => setNewLog({ ...newLog, revDone: value })}
                                      >
                                        <SelectTrigger>
                                          <SelectValue />
                                        </SelectTrigger>
                                    ...
                                    <div className="space-y-2">
                                      <Label htmlFor="revGrade">درجة المراجعة</Label>
                                      <Input
                                        id="revGrade"
                                        value={newLog.revGrade}
                                        onChange={(e) => setNewLog({ ...newLog, revGrade: e.target.value })}
                                ...
                                <Button onClick={handleAddLog} variant="islamic" className="w-full">
                                  إضافة السجل
                                </Button>
                              </div>
                            </DialogContent>
